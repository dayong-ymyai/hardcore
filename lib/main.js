    ...
    _createClass(Trtd, [{
        ...
        value: function initModel(model) {
            ...
            for (var i = 0; i < tmpModel.nodeDataArray.length; i++) {
                ...
                if (tmpModel.nodeDataArray[i].category == "autoText" && tmpModel.nodeDataArray[i].subRole == "themeText" && tmpModel.nodeDataArray[i].orderX == 10 && tmpModel.nodeDataArray[i].orderY == 10) {
